...
**`core` (56 tools — roughly half of `full`) is defined as "every bundled skill keeps
...
Measured 2026-08-05: `full` 136 tools / ~64.7k chars / ~16.2k tokens; `core` 56 tools /
~35.7k chars / ~8.9k tokens. Measure with `model_dump(exclude_none=True, by_alias=True)` and compact JSON
